<div class="row">
  <div class="col-md-8">
    ...
    <div class="form-group position-relative">
      ...
      <input type="hidden" id="customer_phone_no" name="customer_phone_no"
        value="{{ old('customer_phone_no', isset($usedCarAdvance->customer) ? $usedCarAdvance->customer->phone_no : '') }}">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" id="customer_name" name="customer_name" class="form-control" readonly
            value="{{ old('customer_name', isset($usedCarAdvance->customer) ? $usedCarAdvance->customer->name : '') }}">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" id="customer_pan_no" name="customer_pan_no" class="form-control" readonly
            value="{{ old('customer_pan_no', isset($usedCarAdvance->customer) ? $usedCarAdvance->customer->pan_number : '') }}">
        </div>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="text" name="order_booking_number"
            ...
            value="{{ old('order_booking_number', $usedCarAdvance->order_booking_number ?? '') }}" required>
    ...
    <div class="form-group">
      ...
      <input type="text" name="vehicle_registration_no"
        ...
        value="{{ old('vehicle_registration_no', $usedCarAdvance->vehicle_registration_no ?? '') }}" required>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input type="text" name="car_maker" class="form-control @error('car_maker') is-invalid @enderror"
            id="car_maker" placeholder="Enter car maker"
            value="{{ old('car_maker', $usedCarAdvance->car_maker ?? '') }}" required>
          @error('car_maker')
          <small class="error invalid-feedback" role="alert">{{ $message }}</small>
          @enderror
        </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input type="text" name="car_model" class="form-control @error('car_model') is-invalid @enderror"
            id="car_model" placeholder="Enter car model"
            value="{{ old('car_model', $usedCarAdvance->car_model ?? '') }}" required>
          @error('car_model')
          <small class="error invalid-feedback" role="alert">{{ $message }}</small>
          @enderror
        </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input type="text" name="car_color" class="form-control @error('car_color') is-invalid @enderror"
            id="car_color" placeholder="Enter car color"
            value="{{ old('car_color', $usedCarAdvance->car_color ?? '') }}" required>
          @error('car_color')
          <small class="error invalid-feedback" role="alert">{{ $message }}</small>
          @enderror
        </div>
    ...
    <div class="form-group">
      ...
      <input type="text" name="so_name" class="form-control @error('so_name') is-invalid @enderror" id="so_name"
        placeholder="Enter So Name" value="{{ old('so_name', $usedCarAdvance->so_name ?? '') }}" required>
      @error('so_name')
      <small class="error invalid-feedback" role="alert">{{ $message }}</small>
      @enderror
    </div>
    ...
    <div class="form-group">
      ...
      <input type="number" step="0.01" name="total_amount"
        ...
        placeholder="Enter total amount" value="{{ old('total_amount', $usedCarAdvance->total_amount ?? '') }}"
        required>
      @error('total_amount')
      <small class="error invalid-feedback" role="alert">{{ $message }}</small>
      @enderror
    ...
    <div class="form-group d-flex justify-content-between mt-4">
      <div>
        <button type="submit" class="btn btn-primary" name="action" value="save">
          {{ isset($usedCarAdvance) ? 'Update' : 'Save' }}
        </button>
        <button type="submit" class="btn btn-info" name="action" value="save_generate_receipt">
          {{ isset($usedCarAdvance) ? 'Update and Generate Receipt' : 'Save and Generate Receipt' }}
        </button>
      </div>
      <a href="{{ route('admin.used-car-advances.index') }}" class="btn btn-secondary">Cancel</a>
    </div>
  </div>
  ...
  <div class="col-md-4">
    ...
    <div class="text-left">
      @if(isset($usedCarAdvance) && $usedCarAdvance->id)
      <a href="{{ route('admin.used-car-advances.receipt', $usedCarAdvance) }}" class="btn btn-info" target="_blank">
...
@include('admin.used-car-advances._scripts')
