<div class="row">
  <div class="col-md-8">
    ...
    <div class="form-group position-relative">
      ...
      <input type="hidden" id="customer_phone_no" name="customer_phone_no"
        value="{{ old('customer_phone_no', isset($counterSale->customer) ? $counterSale->customer->phone_no : '') }}">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" id="customer_name" name="customer_name" class="form-control" readonly
            value="{{ old('customer_name', isset($counterSale->customer) ? $counterSale->customer->name : '') }}">
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" id="customer_pan_no" name="customer_pan_no" class="form-control" readonly
            value="{{ old('customer_pan_no', isset($counterSale->customer) ? $counterSale->customer->pan_number : '') }}">
        </div>
      </div>
    </div>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="order_booking_number"
            ...
            value="{{ old('order_booking_number', $counterSale->order_booking_number ?? '') }}" required>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="invoice_number" class="form-control @error('invoice_number') is-invalid @enderror"
            ...
            value="{{ old('invoice_number', $counterSale->invoice_number ?? '') }}" required>
    ...
    <div class="form-group">
      ...
      <input type="number" step="0.01" name="total_amount"
        ...
        placeholder="Enter total amount" value="{{ old('total_amount', $counterSale->total_amount ?? '') }}" required>
      @error('total_amount')
      <small class="error invalid-feedback" role="alert">{{ $message }}</small>
      @enderror
    </div>
    ...
    <div class="form-group d-flex justify-content-between mt-4">
      <div>
        <button type="submit" class="btn btn-primary" name="action" value="save">
          {{ isset($counterSale) ? 'Update' : 'Save' }}
        </button>
        <button type="submit" class="btn btn-info" name="action" value="save_generate_receipt">
          {{ isset($counterSale) ? 'Update and Generate Receipt' : 'Save and Generate Receipt' }}
        </button>
      </div>
      <a href="{{ route('admin.counter-sales.index') }}" class="btn btn-secondary">Cancel</a>
    </div>
  </div>
  ...
  <div class="col-md-4">
    ...
    <div class="text-left">
      @if(isset($counterSale) && $counterSale->id)
      <a href="{{ route('admin.counter-sales.receipt', $counterSale) }}" class="btn btn-info" target="_blank">
...
@include('admin.counter-sales._scripts')
